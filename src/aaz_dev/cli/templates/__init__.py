    ...
    if _templates is None:
        ...
        _templates = {
            ...
            'extension': {
                ...
                "fllmext_": {
                    "__init__.py": env.get_template("extension/fllmext_/__init__.py.j2"),
                    "_help.py": env.get_template("extension/fllmext_/_help.py.j2"),
                    "_params.py": env.get_template("extension/fllmext_/_params.py.j2"),
                    # "fllmext_metadata.json": env.get_template("extension/fllmext_/fllmext_metadata.json.j2"),
                    "commands.py": env.get_template("extension/fllmext_/commands.py.j2"),
                    "custom.py": env.get_template("extension/fllmext_/custom.py.j2"),
                    "tests": {
                        "__init__.py": env.get_template("extension/fllmext_/tests/__init__.py.j2"),
                        "profile": {
                            "__init__.py": env.get_template("extension/fllmext_/tests/profile/__init__.py.j2"),
                            "test_.py": env.get_template("extension/fllmext_/tests/profile/test_.py.j2"),
                        }
                    }
                }
            },
