...
class Update(AAZCommand):
    ...
    class AutomationRulesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_automation_rule_read(cls._schema_on_200)
    ...
    class AutomationRulesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_automation_rule_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_automation_rule_read(cls, _schema):
        if cls._schema_automation_rule_read is not None:
            _schema.etag = cls._schema_automation_rule_read.etag
            _schema.id = cls._schema_automation_rule_read.id
            _schema.name = cls._schema_automation_rule_read.name
            _schema.properties = cls._schema_automation_rule_read.properties
            _schema.system_data = cls._schema_automation_rule_read.system_data
            _schema.type = cls._schema_automation_rule_read.type
            return

        cls._schema_automation_rule_read = _schema_automation_rule_read = AAZObjectType()
        ...
        cls._build_schema_client_info_read(properties.created_by)
        ...
        cls._build_schema_client_info_read(properties.last_modified_by)
