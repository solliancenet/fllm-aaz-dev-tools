...
class CMDSubscriptionIdArgBase(CMDStringArgBase):
    ...
    # subscription
class CMDInstanceIdArgBase(CMDStringArgBase):
    TYPE_VALUE = "InstanceId"

class CMDSubscriptionIdArg(CMDSubscriptionIdArgBase, CMDStringArg):
    pass

class CMDInstanceIdArg(CMDInstanceIdArgBase, CMDStringArg):
    pass
        ...
        if self.blank:
            if not isinstance(self.blank.value, float) and not (self.nullable and self.blank.value is None):
                if isinstance(self.blank.value, int):
                    ...
                    pass
                    #raise exceptions.VerificationError(f"Invalid blank value", details=f"'{self.blank.value}' is not a valid float arg value")
